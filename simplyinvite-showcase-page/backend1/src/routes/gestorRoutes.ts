...
import * as gestorController from '../controllers/gestorController';
...
const feedbackValidation = [
  ...
  body('oportunidade.descricao')
    .optional()
    .notEmpty()
    .withMessage('Descrição da oportunidade é obrigatória quando há oportunidade')
];
...
router.get('/talentos/:talentoId/historico', gestorController.buscarHistoricoInteracoes);
...
router.post('/talentos/:talentoId/favoritar', gestorController.favoritarTalento);
router.delete('/talentos/:talentoId/favoritar', gestorController.removerFavorito);
